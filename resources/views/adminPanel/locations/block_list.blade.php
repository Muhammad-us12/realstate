                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <h4 class="page-title">Blocks List</h4>
                                            </div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="table-responsive">
                                            <table id="scroll-horizontal-datatable" class="table table-centered w-100 nowrap">
                                                ...
                                                <tbody>
                                                @isset($Blocks_data)
                                                        @foreach($Blocks_data as $block_res)
                                                            <tr>
                                                                <td>
                                                                    {{ $block_res->id }}
                                                                </td>
                                                                ...
                                                                <td>
                                                                    {{ $block_res->block_name }}

                                                                   
                                                                </td>
                                                                <td>
                                                                    {{ $block_res->BlockSociety->society_name }}
                                                                </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="standard-modalLabel">Add Blocks</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                                </div>
                                <form action="{{ URL::to('block-submit') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                
                                    <div class="mb-3">
                                        <label for="example-input-normal" class="form-label">Select Society</label>
                                        <select class="form-select" name="scoiety" id="example-select">
                                            @foreach($Societies as $Societies_res)
                                                <option value="{{ $Societies_res->id }}">{{ $Societies_res->society_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Block Name</label>
                                        <input type="text" class="form-control" name="block_name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Block Name">
                                        @error('block_name')
