@extends('adminPanel/print_master')   
    @section('content')
    <h3 style="margin-top:40px;">Sale DateWise Files report</h3>
        ...
        <div class="row pl-5 pr-5">
            ...
            <div class="col-md-9"><h6>Start Date: {{ date('d-m-Y',strtotime($start)) }}</h6></div>
            <div class="col-md-3"><h6>End Date: {{ date('d-m-Y',strtotime($end)) }}</h6></div>
            ...
            <div class="col-md-12">
                ...
                <thead style="color: black; border: 1px solid black;">
                    <tr style="background-color: lightgray; color: black;">
                        ...
                        <th style="border:1px solid black;">Sale Date</th>
                ...
                <tbody style="border: 2px solid black;">
                    ...
                    @isset($files_data)
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid black;">{{ date('d-m-Y',strtotime($file_res->purchase_date)) }}</td>
                            <td style="border:1px solid black;">{{ date('d-m-Y',strtotime($file_res->sold_date)) }}</td>
