                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ URL::to('location-submit') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-2">
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="example-input-normal" class="form-label">Location Name</label>
                                                        <input type="text" id="example-input-normal" name="location_name" class="form-control" placeholder="Location Name">
                                                        @error('location_name')
