@extends('adminPanel/print_master')   
    @section('content')
    <h3 style="margin-top:40px;">Location Wise Property report</h3>
        ...
        <div class="row pl-5 pr-5">
            ...
            <div class="col-md-3"><h6>Sate Type: 
            <?php 
                if($request_data['property_type'] == 1){
                    echo "All Types";
                }else{
                    echo $request_data['property_type'];
                }
            ?>
            </h6></div>
            <div class="col-md-9"><h6>Property Type: 
            <?php 
                if($request_data['property_type_comm'] == 1){
                    echo "All Types";
                }else{
                    echo $request_data['property_type_comm'];
                }
            ?>
            </h6></div>
            <div class="col-md-3"><h6>Reporting Date: {{ date('d-m-Y') }}</h6></div>
            <div class="col-md-9"><h6>Start Date: {{ date('d-m-Y',strtotime($request_data['start_date'])) }}</h6></div>
            <div class="col-md-3"><h6>End Date: {{ date('d-m-Y',strtotime($request_data['end_date'])) }}</h6></div>
            <div class="col-md-9"><h6>Reporting Time: {{ date('h:i:sa') }}</h6></div>
            <div class="col-md-3"><h6>User: {{ Helper::getUserName(\Auth::user()->id) }}</h6></div>
            <div class="col-md-9"><h6>Location: {{ $location_data->location_name }}</h6></div>
        </div>
