...
@extends('adminPanel/master') 
         ...
         @section('content')        
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <form action="{{ URL::to('property_update') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row mb-2">
                                                <div class="col-sm-5">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-sm-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="example-input-normal" readonly name="id" value="{{ $property_data->id }}" class="form-control" placeholder="Normal">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" required name="title" value="{{ $property_data->title }}" class="form-control" placeholder="Enter Title">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control select2" name="location_id" onchange="fetchLocatonsSocities()"  id="file_location" data-toggle="select2">
                                                            @isset($Location_data)
                                                                ...
                                                                <option @isset($property_data) @if($property_data->location_id == $location_res->id) selected @endif @endisset value="{{ $location_res->id }}">{{ $location_res->location_name }}</option>
                                                                @endforeach
                                                            @endisset
                                                        </select>
                                                        @error('location_id')
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="mb-3">
                                                    <img src="{{ asset('public/images/Societies/'.$property_data->img.'') }}" style="width:100px; height:100px" alt="property-img" title="contact-img" class="rounded me-3" height="48" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="Propertytype" name="property_type" onchange="checkPropertyType()">
                                                                <option @isset($property_data) @if($property_data->state_type == 'Commerical') selected @endif @endisset value="Commerical">Commerical</option>
                                                                <option @isset($property_data) @if($property_data->state_type == 'Residentail') selected @endif @endisset value="Residentail">Residentail</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3 Residentail">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="property_type_resid">
                                                                <option @isset($property_data) @if($property_data->property_type == 'Shop') selected @endif @endisset value="Shop">Shop</option>
                                                                <option @isset($property_data) @if($property_data->property_type == 'Plot') selected @endif @endisset value="Plot">Plot</option>
                                                                <option @isset($property_data) @if($property_data->property_type == 'House') selected @endif @endisset value="House">House</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3 Commerical">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="property_type_comm">
                                                                <option @isset($property_data) @if($property_data->property_type == 'Plot') selected @endif @endisset value="Plot">Plot</option>
                                                                <option @isset($property_data) @if($property_data->property_type == 'Plaza') selected @endif @endisset value="Plaza">Plaza</option>
                                                                <option @isset($property_data) @if($property_data->property_type == 'Shop') selected @endif @endisset value="Shop">Shop</option>
                                                                <option @isset($property_data) @if($property_data->property_type == 'House') selected @endif @endisset value="House">House</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-3 Commerical">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="example-input-normal" name="area" value="{{ $property_data->area }}" class="form-control" placeholder="Enter Area">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3 Commerical">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="example-input-normal" name="road_size" value="{{ $property_data->road_size }}"  class="form-control" placeholder="Enter Road Size">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3 Commerical">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="example-input-normal" name="street_size" value="{{ $property_data->street_size }}" class="form-control" placeholder="Enter Street Size">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="example-input-normal" required name="demand_amount" value="{{ $property_data->demand_amount }}" class="form-control" placeholder="Purchase Amount">
                                                        @error('demand_amount')
                                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                            @enderror 
                                                    </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="example-input-normal" required name="taken_amount" value="{{ $property_data->taken_amount }}" class="form-control" placeholder="Purchase Amount">
                                                        @error('taken_amount')
                                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                            @enderror 
                                                    </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="example-input-normal" name="owner_name" value="{{ $property_data->owner_name }}" class="form-control" placeholder="Enter Name">
                                                        @error('owner_name')
                                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                            @enderror 
                                                    </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="example-input-normal" name="owner_phone" value="{{ $property_data->owner_phone_no }}" class="form-control" placeholder="Enter Phone No.">
                                                        @error('owner_phone')
                                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                            @enderror 
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control select2" name="customer_id" data-toggle="select2">
                                                            @isset($Customers_data)
                                                                ...
                                                                <option @isset($property_data) @if($property_data->customer_id == $cust_res->id) selected @endif @endisset value="{{ $cust_res->id }}">{{ $cust_res->id }} / {{ $cust_res->custfname." ".$cust_res->custlname }}</option>
                                                                @endforeach
                                                            @endisset
                                                        </select>
                                                        @error('customer_id')
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control select2" name="agent_id" data-toggle="select2">
                                                            @isset($Agent_data)
                                                                ...
                                                                <option @isset($property_data) @if($property_data->agent_id == $agent_res->id) selected @endif @endisset value="{{ $agent_res->id }}">{{ $agent_res->id }} / {{ $agent_res->fname." ".$agent_res->lname }}</option>
                                                                @endforeach
                                                            @endisset
                                                        </select>
                                                        @error('agent_id')
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="summernote" name="description">{{ $property_data->description }}</textarea>
                                                        @error('description')
                                                                <p class="text-danger mt-2">{{ $message }}</p>
                                                        @enderror                                               
                                                    </div>
         ...
         <script>
            ...
            var location_id = '{{ $property_data->location_id }}';
            var society_id = '{{ $property_data->society_id }}';
            var state_type_id = '{{ $property_data->state_type }}';
            var property_marla = '{{ $property_data->marala_type  }}';
            ...
            fetchLocatonsSocities = ()=>{
                    $.ajax({
                        ...
                        success:function(data) {
                            ...
                            if(counter == 1){
                                $('#societies').val(society_id).change();
                            }
                            counter++;
                ...
                fetchMaralaTypes = ()=>{
                    $.ajax({
                        ...
                        success:function(data) {
                            ...
                            $('#select_marala').val(property_marla).change();
