                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#block_wise_file" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
                                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                                            <span class="d-none d-md-block">Block Wise</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#purhcase_date_wise" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
                                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                                            <span class="d-none d-md-block">Date Wise File</span>
                                                        </a>
                                                    </li>
                                                    <!-- <li class="nav-item">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane show active" id="status_wise_file">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Satus Wise Files Report</h5></div>
                                                                <div class="col-md-12">
                                                                    <form action="{{ URL::to('status-wise-files') }}" target="blank" method="post">
                                                                    @csrf    
                                                                    <div class="row mt-3">
                                                                            <div class="col-md-10">
                                                    ...
                                                    <div class="tab-pane" id="date_wise_cash_ledeger">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Location Wise Files Reports</h5></div>
                                                                <div class="col-md-12">
                                                                    <form action="{{ URL::to('location-wise-files') }}" target="blank" method="post">
                                                                    @csrf    
                                                                    <div class="row mt-3">
                                                                            <div class="col-md-8">
                                                    ...
                                                    <div class="tab-pane" id="society_wise_files">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Societies Wise Files</h5></div>
                                                                <div class="col-md-12">
                                                                    <form action="{{ URL::to('societies-wise-files') }}" target="blank" method="post">
                                                                    @csrf    
                                                                    <div class="row mt-3">
                                                    ...
                                                    <div class="tab-pane" id="block_wise_file">
                                                        
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Block Wise Files</h5></div>
                                                                <div class="col-md-12">
                                                                <form action="{{ URL::to('societies-block-wise-files') }}" target="blank" method="post">
                                                                    @csrf    
                                                                    <div class="row mt-3">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="mb-3">
                                                                                <label for="example-input-normal" class="form-label">Select Location</label>
                                                                                <select class="form-control select2" name="location_id" onchange="fetchLocatonsSocities('file_location2','societies_id')" id="file_location2" data-toggle="select2">
                                                                                    @isset($Location_data)
                                                                                        @foreach($Location_data as $location_res)
                                                                                        <option value="{{ $location_res->id }}">{{ $location_res->location_name }}</option>
                                                                                        @endforeach
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="mb-3">
                                                                                <label for="example-input-normal" class="form-label">Select Society</label>
                                                                                <select class="form-control select2" id="societies_id" name="society_id" onchange="fetchSocitiesBlocks()" data-toggle="select2">
                                                    ...
                                                    <div class="tab-pane" id="marala_wise_file">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Marala Wise Files Report</h5></div>
                                                                <div class="col-md-12">
                                                                    <form action="{{ URL::to('marala-wise-files') }}" target="blank" method="post">
                                                                    @csrf    
                                                                    <div class="row mt-3">
                                                    ...
                                                    <div class="tab-pane" id="purhcase_date_wise">
                                                        
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                                                    <li class="nav-item">
                                                                        <a href="#status_date_wise_file" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0 active">
                                                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                                                            <span class="d-none d-md-block">Purchase Wise</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="#location_date_wise_file" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
                                                                            <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                                                            <span class="d-none d-md-block">Sale Wise</span>
                                                                        </a>
                                                                    </li>
                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane show active" id="status_date_wise_file">
                                                            
                                                                        <div class="row">
                                                                            <div class="col-md-12"><h5>Date Wise Purchase Files Report</h5></div>
                                                                                <div class="col-md-12">
                                                                                    <form action="{{ URL::to('purchase-status-wise-files') }}" target="blank" method="post">
                                                                                    @csrf    
                                                                                    <input type="text" name="report_type" value="status_wise" hidden id="">
                                                                                    <div class="row mt-3">
                                                                                            <div class="col-md-3">
                                                                    ...
                                                                    <div class="tab-pane" id="location_date_wise_file">
                                                                            
                                                                        <div class="row">
                                                                            <div class="col-md-12"><h5>Date Wise Sale Files Report</h5></div>
                                                                                <div class="col-md-12">
                                                                                    <form action="{{ URL::to('sale-status-wise-files') }}" target="blank" method="post">
                                                                                    @csrf    
                                                                                    <input type="text" name="report_type" value="status_wise" hidden id="">
                                                                                    <div class="row mt-3">
                                                                                            <div class="col-md-3">
