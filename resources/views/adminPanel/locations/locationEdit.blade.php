                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="text-sm-end">
                                                    <a href="{{ URL::to('locations-list') }}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i>Location List</a>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                        <form action="{{ URL::to('location-update/'.$Location_data->id.'') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-2">
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="example-input-normal" class="form-label">Location Name</label>
                                                        <input type="text" id="example-input-normal" name="location_name" value="{{ $Location_data->location_name }}" class="form-control" placeholder="Location Name">
                                                        @error('location_name')
                                                ...
                                                <div class="col-sm-2">
                                                     <img src="{{ asset('/public/images/locations/'.$Location_data->picture.'') }}" style="width:100px; height:100px" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />
                                                </div>
