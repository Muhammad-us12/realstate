                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="text-sm-end">
                                                    <a href="{{ URL::to('add-buyer') }}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add New Buyer</a>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table table-centered w-100 nowrap">
                                                ...
                                                @isset($buyersData)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="public/images/persons/{{ $buyer->picture }}" style="width:100px; height:100px" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />                                                           
                                                        </td>
                                                        ...
                                                        <td>
                                                            {{ number_format($buyer->opening_bal) }}
                                                        </td>
                                                        <td>
                                                            {{ number_format($buyer->BuyerBalance->balance) }}
                                                        </td>
                                                        <td>
                                                                @php
                                                        ...
                                                        <td class="table-action">
                                                            ...
                                                            <?php 
                                                                        ...
                                                                        if($user_role == 'admin'){
                                                                    ?>
                                                                        <a href="{{ URL::to('buyer-update/'.$buyer->id.'') }}" class="action-icon text-success"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                                    <?php 
                                                                        }
                                                                    ?>
