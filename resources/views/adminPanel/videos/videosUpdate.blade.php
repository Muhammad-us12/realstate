                            ...
                            @endif
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ URL::to('videos-update/'.$video_data->id.'') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-2">
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        <label for="example-input-normal" class="form-label">Title</label>
                                                        <input type="text" id="example-input-normal"  name="title" value="{{ $video_data->title }}" class="form-control" placeholder="Enter Title">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select select2" name="video_category" id="example-select">
                                                            ...
                                                            <option value="{{ $cat_res->id }}"  @if($video_data->video_category == $cat_res->id) {{ "selected" }} @endif>{{ $cat_res->category_name }}</option>
                                                                @endforeach
                                                            @endisset
                                                        </select>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select select2" name="scoiety_id" id="example-select">
                                                            ...
                                                            <option value="{{ $scoitey_res->id }}" @if($video_data->scoiety_id == $scoitey_res->id) {{ "selected" }} @endif>{{ $scoitey_res->society_name }}</option>
                                                                @endforeach
                                                            @endisset
                                                        </select>
                                                        @error('scoiety_id')
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"  id="video_link_input" value="{{ $video_data->video_link }}" name="video_link" class="form-control">
                                                        @error('video_link')
                                                            <p class="text-danger mt-2">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="summernote" name="description">{{ $video_data->description }}</textarea>
                                                        @error('description')
                                                                <p class="text-danger mt-2">{{ $message }}</p>
                                                        @enderror
                                                    </div>
