                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                            <form action="{{ URL::to('payments-sub') }}" id="payment_from" method="post" data-select2-id="6">
                                                @csrf
                                                <div class="mt-3" data-select2-id="5">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <button type="button" name="submit_payments" onclick="disabledSubmitButton(this)" id="sub_pys" class="btn btn-primary">
                                                            Save
                                                        </button>
                                                        </div>
                                                    </div>  
