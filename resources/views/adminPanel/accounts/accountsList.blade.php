                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <h4 class="page-title">Accounts List</h4>
                                            </div>
                                            <div class="col-sm-7">
                                            ...
                                            <table id="scroll-horizontal-datatable" class="table table-centered w-100 nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $cash_res->account_name }}
                                                        </td>
                                                        <td>
                                                            {{ $cash_res->account_number }}
                                                        </td>

                                                        <td>
                                                            {{ number_format($cash_res->opening_bal) }}
                                                        </td>

                                                        <td>
                                                            {{ number_format($cash_res->AccountBalance->balance) }}
                                                        </td>
                                                       
                                                        <td class="table-action">
                                                            <a href="{{ URL::to('accounts-ledeger/'.$cash_res->id) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
