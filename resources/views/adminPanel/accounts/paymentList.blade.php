                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="scroll-horizontal-datatable" class="table table-centered w-100 nowrap">
                                                ...
                                                <tbody>
                                                    @isset($payments_list)
                                                        @foreach($payments_list as $pay_res)
                                                    <tr>
                                                        <td>
                                                            {{ $pay_res->id }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            {{ $pay_res->PaymentFrom->account_name; }}
                                                        </td>
                                                       

                                                        <td>
                                                            {{ number_format($pay_res->total_payments) }}
                                                        </td>

                                                        <td>
                                                            {{ date('d-m-Y',strtotime($pay_res->date)) }}
                                                        </td>
                                                       
                                                        <td class="table-action">
                                                            <a href="{{ URL::to('payment-list-print/'.$pay_res->id.'') }}" target="blank" class="action-icon text-success"> <i class="dripicons-print"></i></a>
                                                        </td>
                                                    </tr>
                                                        @endforeach
                                                    @endisset
